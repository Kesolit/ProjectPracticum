...
import './Register.css'
import { registerUser, API_BASE_URL } from '../../api/api'
import { 
  validateEmail, 
  validatePassword, 
  validateName, 
...
const Register = () => {
  // Хук для отслеживания мобильного экрана
  ...
  // Обработчик входа/регистрации через Google
  ...
  // ЕСЛИ ЭКРАН МОБИЛЬНЫЙ — ОТДАЕМ МОБИЛЬНЫЙ КОМПОНЕНТ
  if (isMobile) {
    return <RegisterMobile handleGoogleLogin={handleGoogleLogin} />;
  }
        ...
        <div className="register-container">
          ...
          <form onSubmit={handleSubmit} autoComplete="off">
            ...
            <div className="form-group full-width">
              ...
              {errors.confirmPassword && <span className="error-message-text">{errors.confirmPassword}</span>}
            </div>
